...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-primary text-primary-foreground shadow-card hover:shadow-hover hover:scale-105",
        destructive:
        ...
        hero: "bg-gradient-primary text-primary-foreground shadow-hero hover:shadow-hover hover:scale-105 font-semibold",
        cta: "bg-primary text-primary-foreground shadow-card hover:bg-primary-dark hover:shadow-hover transform hover:scale-105 font-medium",
      },
      size: {
